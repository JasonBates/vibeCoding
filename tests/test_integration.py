...
from streamlit_app import generate_poem, _poem_lines
...
class TestIntegration:
    ...
    def test_cli_and_streamlit_consistency(self, mock_env_vars, sample_subject):
        ...
        mock_client = Mock()
        mock_response = Mock()
        mock_response.output_text = "Test haiku line 1\nTest haiku line 2\nTest haiku line 3"
    ...
    def test_error_handling_consistency(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            with patch('simple_llm_request.load_dotenv'):  # Mock load_dotenv to prevent .env loading
        ...
        with patch.dict(os.environ, {}, clear=True):
            with patch('streamlit_app.load_dotenv'):  # Mock load_dotenv to prevent .env loading
